...
echo ""
echo "Expo Go URL (clickable — opens Expo Go)"
echo "---------------------------------------"
echo "$CLICKABLE_URL"
echo ""
...
echo "Tap the https link on your phone (it redirects into Expo Go)."
echo "If the redirect is blocked, paste the exp:// URL in Expo Go → Enter URL."
